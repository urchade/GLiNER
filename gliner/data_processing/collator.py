...
class BaseTokenCollator(BaseDataCollator):
    ...
    def _add_token_fields(
        ...
        model_input.update({
            "text_lengths": raw_batch.get('seq_length'),
            "entities_id": raw_batch.get('entities_id')
        })
...
class SpanDataCollator(BaseSpanCollator):
    ...
    def __init__(
        ...
        """
        super().__init__(
            config, data_processor, return_tokens,
            return_id_to_classes, return_entities, prepare_labels
        )

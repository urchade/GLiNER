...
- Synthetic data generation example is [available](synthetic_data_generation)[https://github.com/urchade/GLiNER/blob/main/examples/synthetic_data_generation.ipynb]

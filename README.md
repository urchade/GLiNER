...
- Synthetic data generation example is available (examples/synthetic_data_generation)[https://github.com/urchade/GLiNER/blob/main/examples/synthetic_data_generation.ipynb]
